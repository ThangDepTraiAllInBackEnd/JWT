	...
	public class BaseService<T> : IBaseService<T> where T : class
	{
		...
		public async virtual Task<ServiceResult> UpdateServiceAsync(T entity)
		{
			...
			return new ServiceResult()
			{
				...
				Success = false,
				Code = System.Net.HttpStatusCode.BadRequest,
				MsgResource_VN = CleanArchitecture.Core.Resources.MsgResource_VN.UpdateErr,
				UserMsg = CleanArchitecture.Core.Resources.MsgResource_VN.UpdateErr
			};
		}
		...
		public async virtual Task<ServiceResult> DeleteServiceAsync(T entity)
		{
			...
			return new ServiceResult()
			{
				...
				Success = false,
				Code = System.Net.HttpStatusCode.BadRequest,
				MsgResource_VN = CleanArchitecture.Core.Resources.MsgResource_VN.DeleteErr,
				UserMsg = CleanArchitecture.Core.Resources.MsgResource_VN.DeleteErr
			};
		}
